...
function Milestones({ gender, months }: MilestonesProps) {
  let age;
  if (months <= 13) {
  ...
  let subject = gender === "male" ? "he" : "she";
  let reflexive = gender === "male" ? "himself" : "herself";
    ...
    case 0:
      return (
        <div className="text-center">
          ...
          <p>
            On this page you'll find milestones to look forward to starting at
            the age of 2 months, so stay tuned!
          </p>
          <p>
            In the meantime, your parents should consult with your pediatrician
            if they have any questions about your growth and development.
          </p>
        </div>
      );
    case 2:
      ...
      return (
        <>
          ...
          <ul>
            ...
            <li>
              Chuckles (not yet a full laugh) when you try to make {pronoun} {" "}
              laugh
            </li>
            <li>
          ...
          <ul>
            <li>
              Holds head steady without support when you are holding {pronoun}
            </li>
      ...
      return (
        <>
          ...
          <ul>
            ...
            <li>
              Shows several facial expressions, like happy, sad, angry, and
              surprised
            </li>
            <li>Looks when you call {possPronoun} name</li>
          ...
          <ul>
            <li>
              Looks for objects when dropped out of sight (like {possPronoun}{" "}
              spoon or toy)
            </li>
      ...
      return (
        <>
          ...
          <ul>
            ...
            <li>
              Picks things up between thumb and pointer finger, like small bits
              of food
            </li>
          </ul>
        </>
    ...
    default:
      return (
        <div className="text-center">
          ...
          <p>
            You should continue to check with your pediatrician for any
            questions regarding your growth.
          </p>
